      ...
      <div className="first_section  w-full flex flex-col  mx-auto my-0 items-center justify-center pt-24">
        <div className="img_and_content flex text-center text-white">
          ...
          <div className="flex flex-col">
            <p className="text-4xl">Fuqizo Stilin Tënd të Jetës me Zgjedhje të Zgjuara</p>
            <p className="text-sm max-w-[50%] mx-auto mt-9">
              Zbulo një botë mundësish – nga teknologjia dhe mobiliet, te aksesorët, veshjet, dhe shumë më tepër.
Blej, shis ose gjej çdo gjë që të duhet në një vend të vetëm.
        ...
        <p className="text-white pt-3.5 text-center">
          {" "}
        Përzgjedhjet më të pëlqyera dhe më të kërkuara këtë javë.
Zbulo ofertat që nuk duhen humbur!
        </p>
        ...
        <p className="text-sm text-white max-w-[35%] mx-auto mt-9 text-center">
          Nga pajisjet elektronike e pajisjet e shtëpisë, te veshjet, lodrat, aksesorët e makinave apo produktet e kujdesit personal — çdo kategori është menduar për të plotësuar stilin dhe nevojat e tua të përditshme.
...
Karrige që kombinojnë stilin dhe rehatinë      </h2>
    ...
    <div className="relative rounded-2xl p-[3px] bg-linear-to-tr from-[#8b5cf6] via-[#7c3aed] to-[#06b6d4] shadow-[0_0_35px_rgba(139,92,246,0.4)] transition-transform duration-500 hover:scale-[1.02] order-1 lg:order-2">
      ...
      />
       ...
       <section className="bg-black  p-5">
        <p className="text-white text-2xl text-center">Bli thjeshtë, shpejt dhe me besim – gjithçka që kërkon në një vend.”</p>
      </section>
...
Zbulo një platformë moderne ku çdo produkt, çdo ofertë dhe çdo porosi bëhet më e lehtë, më e shpejtë dhe më e mençur.              </p>
            </div>
          </div>
        </div>
